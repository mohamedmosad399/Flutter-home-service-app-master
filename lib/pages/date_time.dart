        ...
        onPressed: () {
          if(selectedService == 0){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'عثمان محمد',work:'Cleaner' ),
              ),
            );
          }
          if(selectedService == 1){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'احمد ابراهيم',work:'Plumber' ),
              ),
            );
          }
          if(selectedService == 2){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'محمد الزونه',work:'Electrican' ),
              ),
            );
          }
          if(selectedService == 3){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'محمد محمود',work:'Painter' ),
              ),
            );
          }
          if(selectedService == 4){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'اشرف وليد',work:'Carpenter' ),
              ),
            );
          }
          if(selectedService == 5){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'احمد سامي',work:'Gardener' ),
              ),
            );
          }
          if(selectedService == 6){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'وليد حسام',work:'Tailor' ),
              ),
            );
          }
          if(selectedService == 7){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'مريم عثمان',work:'Maid' ),
              ),
            );
          }
          if(selectedService == 8){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'احمد كريم',work:'Driver' ),
              ),
            );
          }
          if(selectedService == 9){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HomePage(name: 'مينا جرجس',work:'Cook' ),
              ),
            );
          }
