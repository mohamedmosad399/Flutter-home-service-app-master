...
class HomePage extends StatefulWidget {
  String name;
  String work;
  HomePage({required this.name,required this.work});
...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> workers = [
    ['عاطف حسام', 'Cleaner', 'https://api-private.atlassian.com/users/360a1eb10427f884ff4af21f5ed67aee/avatar', 4.8],
    ['سيد محمود', 'Plumber', 'https://api-private.atlassian.com/users/360a1eb10427f884ff4af21f5ed67aee/avatar', 4.6],
    ['علاء احمد', 'Driver', 'https://api-private.atlassian.com/users/360a1eb10427f884ff4af21f5ed67aee/avatar', 4.4]
  ];
                    ...
                    Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network('https://api-private.atlassian.com/users/360a1eb10427f884ff4af21f5ed67aee/avatar', width: 70,)
                        ),
                        SizedBox(width: 15,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text(widget.work, style: TextStyle(color: Colors.black.withOpacity(0.7), fontSize: 18),),
                          ],
                        )
                      ],
                    ),
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(
                          builder: (context) => Chat(name: widget.name),
                        ));
